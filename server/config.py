class Config:
    ...
    JWT_COOKIE_SECURE = True  # Set to True in production (for HTTPS)
    JWT_COOKIE_HTTPONLY = True  # Prevent JavaScript access
    JWT_COOKIE_SAMESITE = "Lax"  # Prevent CSRF issues

    SQLALCHEMY_DATABASE_URI = "postgresql://dummy_user:dummy_secure_password@localhost:5432/petbuddies"
